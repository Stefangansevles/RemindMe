    ...
    public partial class UCImportExport : UserControl
    {
            ...
            try
            {
                ...
                if (toImportReminders != null)
                {
                    ...
                    foreach (object rem in toImportReminders)
                    {
                        ...
                        {
                            BLFormLogic.AddReminderToListview(lvReminders, (Reminder)rem, false);
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (BLReminder.GetReminders().Count > 0)
            {
                ...
                BLFormLogic.AddRemindersToListview(lvReminders, BLReminder.GetReminders(), false);
            }
        ...
        private void btnRecoverDeleted_Click(object sender, EventArgs e)
        {
            ...
            BLFormLogic.AddRemindersToListview(lvReminders, BLReminder.GetDeletedReminders().OrderBy(rem => rem.Name).ToList(), false);
        ...
        private void btnRecoverOld_Click(object sender, EventArgs e)
        {
            ...
            BLFormLogic.AddRemindersToListview(lvReminders, BLReminder.GetArchivedReminders().OrderBy(rem => rem.Name).ToList(), false);
